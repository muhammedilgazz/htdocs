        ...
        <div class="app-main">
            ...
            <div class="app-content">
                <div class="container-fluid">
                    ...
                    <!-- İstatistik Kartları - Ekash Style -->
                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-3">
                                            <a href="budgets.php" class="quick-action-card">
                                                <div class="text-center">
                                                    ...
                                                    <h6 class="mt-3 mb-2">Budgets</h6>
                                                    <p class="text-muted small">Monthly budget planning</p>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="col-md-3">
                                            <a href="analytics.php" class="quick-action-card">
                                                <div class="text-center">
                                                    ...
                                                    <h6 class="mt-3 mb-2">Analytics</h6>
                                                    <p class="text-muted small">Financial analysis</p>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="col-md-3">
                                            <a href="goals.php" class="quick-action-card">
                                                <div class="text-center">
                                                    ...
                                                    <p class="text-muted small">Savings goals</p>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="col-md-3">
                                            <a href="wallets.php" class="quick-action-card">
                                                <div class="text-center">
                                                    ...
                                                    <h6 class="mt-3 mb-2">Wallets</h6>
                                                    <p class="text-muted small">Account management</p>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
