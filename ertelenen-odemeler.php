...
$rows = $db->fetchAll("SELECT ei.*, c.name as category_name, st.name as status_name FROM expense_items ei JOIN categories c ON ei.category_id = c.id JOIN status_types st ON ei.status_id = st.id WHERE st.name = 'Ertelendi' ORDER BY ei.created_at ASC");
    ...
    <div class="app-main">
        ...
        <div class="container-fluid py-1" style="background:#f7f9fb;">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <div>
                    <h2 class="mb-1" style="font-weight:700; color:#1f2e4e; font-size:1.5rem;">Ertelenen Ödemeler</h2>
                    <div style="color:#7b8ab8; font-size:1rem;">Gelecek tarihlere ertelenmiş ödemeler.</div>
                </div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0" style="background:transparent;">
                        <li class="breadcrumb-item"><a href="index.php" style="color:#7b8ab8; text-decoration:none;">Anasayfa</a></li>
                        <li class="breadcrumb-item active" aria-current="page" style="color:#7b8ab8;">Ertelenen Ödemeler</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="container py-3">
                ...
                <div class="card p-0" style="box-shadow:0 2px 12px 0 rgba(79,140,255,0.06);">
                    <div class="card-header bg-white" style="border-bottom:1px solid #f0f2f7; padding:0.75rem 1rem;">
                        <h5 class="mb-0" style="font-weight:600; color:#222; font-size:1rem;">Ertelenen Ödemeler</h5>
                    </div>
                                    ...
                                    <tr style="font-size:0.85rem;">
                                        ...
                                        <td>
                                            <div class="d-flex gap-1">
                                                ...
                                                <button class="btn btn-outline-success btn-sm" data-id="<?= $row['id'] ?>" style="font-size:0.8rem; padding:0.3rem 0.5rem; min-width:32px;" title="Ödemeyi Tamamla" type="button" onclick="completePostponedExpense(<?= $row['id'] ?>)">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="harcamaEkleModalLabel">Yeni Ertelenen Ödeme Ekle</h5>
                            ...
                            <form id="harcamaEkleForm">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="category_name" name="category_name" value="Ertelenen Ödemeler" required>
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label for="item_name" class="form-label">Ödeme Adı</label>
                                        <input type="text" class="form-control" id="item_name" name="item_name" placeholder="Örn: Kira, Fatura" required>
                                    </div>
                ...
                <div class="modal fade" id="duzenleModal" tabindex="-1" aria-labelledby="duzenleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="duzenleModalLabel">Ertelenen Ödeme Düzenle</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <form id="duzenleForm">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="edit_item_name" class="form-label">Ödeme Adı</label>
