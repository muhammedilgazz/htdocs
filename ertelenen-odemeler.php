...
$rows = $db->fetchAll("SELECT * FROM harcama_kalemleri WHERE erteleme_tarihi IS NOT NULL AND erteleme_tarihi != '' ORDER BY erteleme_tarihi ASC");
                            ...
                            <table class="table align-middle mb-0" style="min-width:900px; font-size:0.9rem;">
                                ...
                                <?php foreach ($rows as $row): ?>
                                    <tr style="font-size:0.85rem;">
                                        ...
                                        <td> 
                                            <?php if (!empty($row['erteleme_tarihi'])): ?>
                                                <span class="badge bg-warning"><?= date('d.m.Y', strtotime($row['erteleme_tarihi'])) ?></span>
                                            <?php else: ?>-
                                            <?php endif; ?>
                                        </td>
                                        <td>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <form id="harcamaEkleForm">
                        <input type="hidden" name="kategori_tipi" value="Ertelenen Ödemeler">
                        <!-- ... diğer form alanları ... -->
                      </form>
                    </div>
                  </div>
