    ...
    <div class="app-main">
        ...
        <div class="app-content">
            <div class="container-fluid">
                <?php
                $page_title = 'Sabit Gelirler';
                $page_description = 'Düzenli ve sabit gelir kayıtlarınızı görüntüleyin ve yönetin.';
                $breadcrumb_active = 'Sabit Gelirler';
                ...
                <div class="d-flex justify-content-end mb-3">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addIncomeModal">
                        <i class="bi bi-plus-circle me-2"></i>Yeni Sabit Gelir Ekle
                    </button>
                </div>
                ...
                <div class="text-center py-5">
                    ...
                    <h4 style="color: #7b8ab8; font-weight: 600; margin-bottom: 0.5rem;">Henüz sabit gelir kaydı yok</h4>
                    <p style="color: #a0a8c0; margin-bottom: 2rem;">Sabit gelirlerinizi ekleyerek takip etmeye başlayın.</p>
                </div>
                <?php else: ?>
                <div class="card p-0">
                    <div class="card-header bg-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">Sabit Gelirler Listesi</h5>
                            <div class="d-flex align-items-center">
                                <?php if (!empty($incomes)): ?>
                                    <h5 class="mb-0 text-end me-3">Toplam: ₺<?= number_format(getTotalInTL($incomes), 2, ',', '.') ?></h5>
                                <?php endif; ?>
                                <button id="export-excel-fixed-incomes" class="btn btn-sm btn-outline-success"><i class="bi bi-file-earmark-excel"></i></button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table id="fixedIncomesTable" class="table align-middle mb-0">
                                <thead>
                                    <tr>
                                        <th>Başlık</th>
                                        <th>Para Birimi</th>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Yeni Sabit Gelir Ekle</h5>
