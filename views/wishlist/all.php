    ...
    <div class="app-main">
        ...
        <div class="app-content">
            <div class="container-fluid">
                <?php
                $page_title = 'İstek Listesi - Tüm Alınacaklar';
                $page_description = 'Tüm istek listesi öğelerinin takibi.';
                $breadcrumb_active = 'Tüm Alınacaklar';
                ...
                <div class="text-center py-5">
                    ...
                    <h4 style="color: #7b8ab8; font-weight: 600; margin-bottom: 0.5rem;">Henüz istek listesi öğesi yok</h4>
                ...
                <div class="card p-0">
                    <div class="card-header bg-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">İstek Listesi Öğeleri</h5>
