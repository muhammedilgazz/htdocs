                ...
                <div class="container-fluid">
                        ...
                        <div class="welcome-card">
                            <div class="welcome-content">
                                ...
                                <div class="welcome-actions">
                                    <button class="btn btn-light">Account purchase</button>
                                    <button class="btn btn-dark">View features</button>
                                </div>
                            </div>
                            <div>
                                <img src="/assets/images/hero.png" alt="Hoş Geldin" class="welcome-hero-img" />
                            </div>
                        </div>
                        <div class="dashboard-graph-card">
                            <div class="cash-header d-flex justify-content-between align-items-start">
                                <div>
                                    <div class="cash-title">MEVCUT KASA</div>
                                    <div class="cash-date"><span class="cash-time">09:20AM</span> <span class="cash-day">04 Jan</span></div>
                                </div>
                                <div class="cash-change up">▲ 2.89%</div>
                            </div>
                            <div class="cash-amount">₺1,567</div>
                            <div class="cash-progressbar">
                                <div class="cash-progressbar-inner" style="width: 80%;"></div>
                            </div>
                            <div class="d-flex justify-content-between cash-footer">
                                <span class="cash-footer-left">0%</span>
                                <span class="cash-footer-right">8%</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dashboard-summary-row">
                        <div class="summary-card expense position-relative">
                            ...
                            <h2>₺250,00</h2>
                            <span class="summary-change down">-5.2%</span>
                            <span class="summary-desc">geçen aya göre</span>
                            <i class="bi bi-receipt summary-icon"></i>
                        </div>
                        <div class="summary-card receivable position-relative">
                            <span>AYLIK ALINACAKLAR</span>
                            <h2>₺9.102.091,88</h2>
                            <span class="summary-change up">+2.1%</span>
                            <span class="summary-desc">geçen aya göre</span>
                        ...
                        <div class="summary-card payment position-relative">
                            ...
                            <h2>₺0,00</h2>
                            <span class="summary-change up">+1.8%</span>
                            <span class="summary-desc">geçen aya göre</span>
                            <i class="bi bi-credit-card summary-icon"></i>
                        </div>
                        <div class="summary-card balance position-relative">
                            <span>TOPLAM BAKİYE</span>
                            <h2>₺0,00</h2>
                            <span class="summary-change up">+8.5%</span>
                            <span class="summary-desc">geçen aya göre</span>
                            <i class="bi bi-pie-chart summary-icon"></i>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-xl-4 mb-4">
                            <div class="card modern-card recent-transactions" data-aos="fade-up" data-aos-delay="100">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5 class="card-title mb-0">Son İşlemler</h5>
                                    <a href="/expense" class="btn btn-sm btn-link">Tümünü Gör</a>
                                </div>
                                <div class="card-body p-0 recent-transactions-list">
                                            ...
                                            <div class="list-group-item border-0 px-4 py-3 transaction-item">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <div
                                                            class="transaction-icon bg-<?= $transaction['type'] == 'expense' ? 'danger' : 'warning' ?> bg-opacity-10 rounded-circle p-2">
                                                            <i
                                                                class="material-icons-round text-<?= $transaction['type'] == 'expense' ? 'danger' : 'warning' ?>">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h6 class="mb-1">
                                                            <?= htmlspecialchars($transaction['description']) ?></h6>
