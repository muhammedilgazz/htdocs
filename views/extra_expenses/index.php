    ...
    <div class="app-main">
        ...
        <div class="app-content">
            <div class="container-fluid">
                <?php
                $page_title = 'Ani/Ekstra Giderler';
                $page_description = 'Plansız ve manuel giriş gerektiren giderler.';
                $breadcrumb_active = 'Ani/Ekstra Giderler';
                include ROOT_PATH . '/views/partials/page_header.php';
                ?>
                <div class="d-flex justify-content-end mb-3">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addExpenseModal">
                        <i class="bi bi-plus-circle me-2"></i>Yeni Ani/Ekstra Gider Ekle
                    </button>
                </div>
                ...
                <div class="text-center py-5">
                    ...
                    <h4 style="color: #7b8ab8; font-weight: 600; margin-bottom: 0.5rem;">Henüz ani/ekstra gider kaydı yok</h4>
                    <p style="color: #a0a8c0; margin-bottom: 2rem;">Ani/ekstra giderlerinizi ekleyerek takip etmeye başlayın.</p>
                </div>
                <?php else: ?>
                <div class="card p-0">
                    <div class="card-header bg-white">
                        <h5 class="mb-0">Ani/Ekstra Giderler Listesi</h5>
                    </div>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table id="extraExpensesTable" class="table align-middle mb-0">
                                <thead>
                                    <tr>
                                        <th>Açıklama</th>
                                        <th>Tutar</th>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Yeni Ani/Ekstra Gider Ekle</h5>
            ...
            <form id="addForm">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="category_type" value="ani_ekstra">
...
<div class="modal fade" id="editExpenseModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Ani/Ekstra Gideri Düzenle</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form id="editForm">
