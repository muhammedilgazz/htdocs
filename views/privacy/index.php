                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Privacy and Poliicy </h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="privacy-content">
                                    ...
                                    <p>
                                        Ekash trading algorithm is integrated into the largest personal finance
                                        management
                                        platforms, including Binance, Poloniex, Bittrex, etc. In the span of
                                        milliseconds,
                                        ...
                                        approximate until the transaction is actually made on the blockchain, which is
                                        why
                                        the exchange rate at the time of a transaction may differ slightly from the
                                        estimated rate that you see when you begin a transaction. To learn more about
                                        the
                                ...
                                <div class="privacy-content">
                                    ...
                                    <p>Ekash is one of the most prominent instant personal finance managements that has
                                        gained the trust of more than 2M users from all over the world. The service
                                        provides
                                        safe and fast transactions without revealing users identities. We provide the
                                        best
                                        possible rates by comparing a wide range of reliable trading platforms and work
                                        with
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <i class="fi fi-ss-circle"></i>
                                            <p>Each account is protected with 2-factor authentication and an HTTPS
                                                protocol.
                                            </p>
                                        </li>
                                        <li>
                                ...
                                <div class="privacy-content">
                                    ...
                                    <p>Ekash mobile app does! Mobile app users will no longer be affected by the risks
                                        associated with cash market fluctuations. Soon, the fixed-rate exchanges will
                                        also
                                        be implemented on the web version. To lock the current exchange rate, the user
                                        needs
                                        to click on the lock icon, which will result in them getting the exact same
                                        amount
                                ...
                                <div class="privacy-content">
                                    ...
                                    <ul>
                                        <li>
                                            <i class="fi fi-ss-circle"></i>
                                            <p>The website will be constantly available, or available at all moving
                                                forward.
                                            </p>
                                        </li>
                                        <li>
                                ...
                                <div class="privacy-content">
                                    <h5>Privacy : </h5>
                                    <p>For details about our privacy policy, please refer to the privacy policy section.
                                    </p>
                                </div>
                                <div class="privacy-content">
                                ...
                                <div class="privacy-content">
                                    <h5>Modifications: </h5>
                                    <p>Ekash.com may revise these terms of use for its website at any time without
                                        notice.
