...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && validate_csrf_token($_POST['csrf_token'])) {
    ...
    if ($sgk_debt_model->update($id, $data)) {
        json_response(['success' => true, 'message' => 'SGK borcu başarıyla güncellendi.']);
    } else {
        json_response(['success' => false, 'message' => 'SGK borcu güncellenirken bir hata oluştu.'], 500);
    }
} else {
