...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && validate_csrf_token($_POST['csrf_token'])) {
    ...
    if ($tax_debt_model->add($data)) {
        json_response(['success' => true, 'message' => 'Vergi borcu başarıyla eklendi.']);
    } else {
        json_response(['success' => false, 'message' => 'Vergi borcu eklenirken bir hata oluştu.'], 500);
    }
} else {
