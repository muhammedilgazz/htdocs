...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && validate_csrf_token($_POST['csrf_token'])) {
    ...
    if ($wishlist_model->update($id, $data)) {
        json_response(['success' => true, 'message' => 'İstek listesi öğesi başarıyla güncellendi.']);
    } else {
        json_response(['success' => false, 'message' => 'İstek listesi öğesi güncellenirken bir hata oluştu.'], 500);
    }
} else {
