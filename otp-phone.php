        ...
        <div class="container h-100">
            <div class="row justify-content-center h-100 align-items-center">
                <div class="col-xl-5 col-md-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <a class="page-back text-muted" href="signin.php">
                                <span><i class="fi fi-ss-angle-small-left"></i></span> Back</a>
                            <h3 class="text-center">2-Step Verification</h3>
                            ...
                            <form action="otp-code.php">
                                ...
                                <div class="mb-3 col-12">
                                    <label class="mb-3">Your phone number</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fi fi-sr-phone-call"></i></span>
                                        </div>
                                        <input name="phone" type="text" class="form-control" value="+1 12365480">
                                    </div>
                                </div>
                            ...
                            <div class="new-account mt-3 d-flex justify-content-between">
                                <p>Don't get code? <a class="text-primary" href="otp-code.php">Resend</a></p>
                            </div>
                        </div>
                    </div>
                </div>
