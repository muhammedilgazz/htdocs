...
$rows = $db->fetchAll("SELECT * FROM harcama_kalemleri WHERE kategori_tipi='Ani/Ekstra Harcama' ORDER BY id DESC");
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <form id="harcamaEkleForm">
                        <input type="hidden" name="kategori_tipi" value="Ani/Ekstra Harcama">
                        <!-- ... diğer form alanları ... -->
                      </form>
                    </div>
                  </div>
