    ...
    <div class="app-main">
        ...
        <div class="container-fluid py-1" style="background:#f7f9fb;">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <div>
                    <h2 class="mb-1" style="font-weight:700; color:#1f2e4e; font-size:1.5rem;">Destek Merkezi</h2>
                    <div style="color:#7b8ab8; font-size:1rem;">Sorularınız için destek ekibimizle iletişime geçin.</div>
                </div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0" style="background:transparent;">
                        <li class="breadcrumb-item"><a href="index.php" style="color:#7b8ab8; text-decoration:none;">Anasayfa</a></li>
                        <li class="breadcrumb-item active" aria-current="page" style="color:#7b8ab8;">Destek</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100" style="box-shadow:0 2px 12px 0 rgba(79,140,255,0.06);">
                            <div class="card-body text-center">
                                ...
                                <a href="support-create-ticket.php" class="btn btn-primary">Oluştur</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="5" class="text-center py-4">
                                            ...
                                            <a href="support-create-ticket.php" class="btn btn-primary btn-sm">İlk Talebinizi Oluşturun</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
